...
const ItemList = (props) => {
    ...
    let cls = props.usr.gender === "male" ? "userItem row justify-content-start" : "userItem row justify-content-start red"
    return (


        <div className={cls}  >

            <div className="col-4 "> <img className="userImg" src={props.usr.mediumPic} alt="" /></div>
